...
(function () {
  ...
  function toggleDesign(on) {
    ...
    if (on) {
      ...
      // 退出 CAD：把结构变化同步进动作模式（关节滑块/末端列表/TCP）
  ...
  document.querySelectorAll("#nd-gbox-w,#nd-gbox-d,#nd-gbox-h,#nd-gcyl-r,#nd-gcyl-h,#nd-gsph-r,#nd-gext-depth").forEach((el) => {
